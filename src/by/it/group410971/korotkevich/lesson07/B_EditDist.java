package by.it.group410971.korotkevich.lesson07;
...
public class B_EditDist {
    ...
    int getDistanceEdinting(String one, String two) {
        ...
        for (int i = 0; i <= m; i++) {
            dp[i][0] = i; // стоимость превращения первых i символов первой строки в пустую строку
        }
        for (int j = 0; j <= n; j++) {
            dp[0][j] = j; // стоимость превращения пустой строки в первые j символов второй строки
        }
